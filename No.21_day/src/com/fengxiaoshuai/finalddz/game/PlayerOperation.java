...
import com.fengxiaoshuai.finalddz.game.Common;
import com.fengxiaoshuai.finalddz.game.GameJFrame;
import com.fengxiaoshuai.finalddz.domain.Poker;
import com.fengxiaoshuai.finalddz.game.Model;
		...
		if (gameJFrame.time[(role + 1) % 3].getText().equals("不要") && gameJFrame.time[(role + 2) % 3].getText().equals("不要")) {
			...
			if (role != gameJFrame.dizhuFlag) {
				...
				if ((role + 1) % 3 == gameJFrame.dizhuFlag) {
					if ((Common.jugdeType(gameJFrame.currentList.get((role + 2) % 3)) != com.fengxiaoshuai.finalddz.game.PokerType.c1
							|| Common.jugdeType(gameJFrame.currentList.get((role + 2) % 3)) != com.fengxiaoshuai.finalddz.game.PokerType.c2)
			...
			com.fengxiaoshuai.finalddz.game.PokerType cType = Common.jugdeType(player);

			if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c1) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 1, 4, 3, 2, 5 });
				AI_1(model.a1, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c2) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 2, 4, 3, 5, 1 });
				AI_1(model.a2, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c3) {
				AI_1(model.a3, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c4) {
				AI_1(model.a4, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c31) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 3, 1, 4, 2, 5 });
				AI_2(model.a3, model.a1, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c32) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 3, 2, 4, 5, 1 });
				AI_2(model.a3, model.a2, player, list, role);
			} else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c411) {
				AI_5(model.a4, model.a1, player, list, role);
			}

			else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c422) {
				AI_5(model.a4, model.a2, player, list, role);
			}

			else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c123) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 5, 3, 2, 4, 1 });
				AI_3(model.a123, player, list, role);
			}

			else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c112233) {
				if (can == 1)
					model = Common.getModel(gameJFrame.playerList.get(role), new int[] { 2, 4, 3, 5, 1 });
				AI_3(model.a112233, player, list, role);
			}

			else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c11122234) {
				AI_4(model.a111222, model.a1, player, list, role);
			}

			else if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c1112223344) {
