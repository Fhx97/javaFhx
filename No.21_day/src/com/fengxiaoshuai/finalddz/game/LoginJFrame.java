...
import com.fengxiaoshuai.finalddz.domain.User;
import com.fengxiaoshuai.finalddz.game.GameJFrame;
import com.fengxiaoshuai.finalddz.domain.User;
import com.fengxiaoshuai.finalddz.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView() {
        ...
        //获取正确的验证码
        String codeStr = com.fengxiaoshuai.finalddz.util.CodeUtil.getCode();
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == login) {
            ...
            //获取一个新的验证码
            String code = com.fengxiaoshuai.finalddz.util.CodeUtil.getCode();
