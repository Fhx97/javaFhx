package com.fengxiaoshuai.finalddz.game;

import com.fengxiaoshuai.finalddz.domain.Poker;
...
public class Common {
    ...
    //判断牌型
    public static com.fengxiaoshuai.finalddz.game.PokerType jugdeType(ArrayList<Poker> list) {
        int len = list.size();
        if (len <= 4) {
            if (list.size() > 0 && Common.getValue(list.get(0)) == Common.getValue(list.get(len - 1))) {
                switch (len) {
                    case 1:
                        return com.fengxiaoshuai.finalddz.game.PokerType.c1;
                    case 2:
                        return com.fengxiaoshuai.finalddz.game.PokerType.c2;
                    case 3:
                        return com.fengxiaoshuai.finalddz.game.PokerType.c3;
                    case 4:
                        return com.fengxiaoshuai.finalddz.game.PokerType.c4;
                }
            }
            ...
            if (len == 4 && ((Common.getValue(list.get(0)) == Common.getValue(list.get(len - 2)))
                ...
                return com.fengxiaoshuai.finalddz.game.PokerType.c31;
            else {
                return com.fengxiaoshuai.finalddz.game.PokerType.c0;
            }
        }
        if (len >= 5) {
    ...
    //重新摆放牌
    public static void rePosition(com.fengxiaoshuai.finalddz.game.GameJFrame m, ArrayList<Poker> list, int flag) {
        Point p = new Point();
        if (flag == 0) {
            p.x = 50;
    ...
    public static com.fengxiaoshuai.finalddz.game.Model getModel(ArrayList<Poker> list, int[] orders) {
        ArrayList list2 = new ArrayList<>(list);
        com.fengxiaoshuai.finalddz.game.Model model = new com.fengxiaoshuai.finalddz.game.Model();
        for (int i = 0; i < orders.length; i++)
            showOrders(orders[i], list2, model);
        return model;
    }

    public static void get123(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
    ...
    public static void getTwoTwo(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
    ...
    public static void getPlane(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        ArrayList<String> del = new ArrayList<>();
    ...
    public static void getBoomb(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        ArrayList<Poker> del = new ArrayList<>();
        if (list.size() < 1)
            return;
    ...
    public static void getThree(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        ArrayList<Poker> del = new ArrayList<>();
        for (int i = 0, len = list.size(); i < len; i++) {
    ...
    public static void getTwo(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        ArrayList<Poker> del = new ArrayList<>();
        for (int i = 0, len = list.size(); i < len; i++) {
    ...
    public static void getSingle(ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        ArrayList<Poker> del = new ArrayList<>();
        for (int i = 0, len = list.size(); i < len; i++) {
    ...
    public static int checkCards(ArrayList<Poker> c, ArrayList<ArrayList<Poker>> current, com.fengxiaoshuai.finalddz.game.GameJFrame m) {
        ArrayList<Poker> currentlist;
        if (m.time[0].getText().equals("不要"))
            currentlist = current.get(2);
        else
            currentlist = current.get(0);
        com.fengxiaoshuai.finalddz.game.PokerType cType = Common.jugdeType(c);
        com.fengxiaoshuai.finalddz.game.PokerType cType2 = Common.jugdeType(currentlist);
        if (cType != com.fengxiaoshuai.finalddz.game.PokerType.c4 && c.size() != currentlist.size())
            return 0;
        if (cType != com.fengxiaoshuai.finalddz.game.PokerType.c4 && Common.jugdeType(c) != Common.jugdeType(currentlist)) {

            return 0;
        }
        if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c4) {
            if (c.size() == 2)
                return 1;
            if (cType2 != com.fengxiaoshuai.finalddz.game.PokerType.c4) {
                return 1;
            }
        }

        if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c1 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c2 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c3 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c4) {
        ...
        if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c123 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c112233 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c111222) {
            if (Common.getValue(c.get(0)) <= Common.getValue(currentlist.get(0)))
                return 0;
            else
                return 1;
        }
        if (cType == com.fengxiaoshuai.finalddz.game.PokerType.c31 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c32 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c411 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c422
                || cType == com.fengxiaoshuai.finalddz.game.PokerType.c11122234 || cType == com.fengxiaoshuai.finalddz.game.PokerType.c1112223344) {
    ...
    public static void showOrders(int i, ArrayList<Poker> list, com.fengxiaoshuai.finalddz.game.Model model) {
        switch (i) {
            case 1:
